            ...
            <div className="w-full sm:w-2/3 sm:pl-8 sm:py-5 mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                ...
                <div className="relative mb-4">
                    ...
                    <input
                        ...
                        className="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                    />
                </div>
                <div className="relative mb-4">
