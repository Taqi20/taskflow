        ...
        <>
            <div className="w-full sm:w-2/3 sm:pl-8 sm:py-8  mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                ...
                <div className="text-gray-300 flex items-center  mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div className="w-11 h-11 md:w-14 md:h-14  sm:mr-10 inline-flex items-center justify-center rounded-full bg-purple-100 text-blue-500 flex-shrink-0">
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Are you sure you want to delete your account from TaskFlow
                        permanently?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
